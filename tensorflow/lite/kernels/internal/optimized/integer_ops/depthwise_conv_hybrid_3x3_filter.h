    ...
    asm volatile(
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_LOOP ":\n"
          ...
          DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LOOP ":\n"
            ...
            // Store to float.
            "st1 {v21.4s, v22.4s}, [" PTR(6) "], x4\n"
            "st1 {v23.4s, v24.4s}, [" PTR(7) "], x4\n"
            // Reset to int
    ...
    asm volatile(
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_LOOP ":\n"
          ...
          DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LOOP ":\n"
            ...
            "dup v28.8h, w0\n"
            // Store.
            "st1 {v19.4s, v20.4s}, [" PTR(7) "], x4\n"
            "st1 {v25.4s, v26.4s}, [" PTR(7) "], x4\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_1_WIDTH_2_LOOP ":\n"
          ...
          "dup v28.8h, w0\n"
          "st1 {v24.4s, v25.4s}, [" PTR(6) "], x4\n"
          "st1 {v26.4s, v27.4s}, [" PTR(6) "], x4\n"
          "fcvtms v24.4s, v24.4s\n"
          "fcvtms v25.4s, v25.4s\n"
          "fcvtms v26.4s, v26.4s\n"
...
#define DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP "2"
    asm volatile(
        ...
        "add " PTR(13) ", " PTR(12) ", x11\n"
        "ldr x15, [%[params_ptr], #" STR(OFFSET_OUTPUT_DEPTH) "]\n"

        "ld1 {v8.8b}, [" PTR(12) "], x7\n"
        "add " PTR(10) ", " PTR(9) ", x14\n"
        "ld1 {v9.8b}, [" PTR(12) "], x7\n"
        "cmp x15, #16\n"
        "ld1 {v10.8b}, [" PTR(12) "]\n"
