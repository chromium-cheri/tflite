...
#define DEPTHWISECONV_LABEL_HEIGHT_1_END "11"
    ...
    asm volatile(
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_LOOP ":\n"
          ...
          // two outputs.
          "mov " PTR(11) ", %[input_ptr]\n"
          "mov " PTR(12) ", " PTR(11) "\n"
          "ld1 {v9.8b}, [" PTR(12) "], %[input_depth]\n"
          "add x13, x11, %[input_row_size]\n"
          "ld1 {v10.8b}, [" PTR(12) "], %[input_depth]\n"
          "add x14, x13, %[input_row_size]\n"
          "ld1 {v11.8b}, [" PTR(12) "], %[input_depth]\n"
          "add x15, x14, %[input_row_size]\n"
          "ld1 {v12.8b}, [" PTR(13) "], %[input_depth]\n"
          "mov w5, %w[output_window_width]\n"
          "ld1 {v13.8b}, [" PTR(13) "], %[input_depth]\n"
          "mov " PTR(6) ", %[output_ptr]\n"
          "ld1 {v14.8b}, [" PTR(13) "], %[input_depth]\n"
          "add " PTR(7) ", %[output_ptr], x1\n"
          "ld1 {v15.8b}, [" PTR(14) "], %[input_depth]\n"
          ...
          "ld1 {v16.8b}, [" PTR(14) "], %[input_depth]\n"
          "uaddw v10.8h, v26.8h, v10.8b\n"
          "ld1 {v17.8b}, [" PTR(14) "], %[input_depth]\n"
          "uaddw v11.8h, v26.8h, v11.8b\n"
          "ld1 {v18.8b}, [" PTR(15) "], %[input_depth]\n"
          "uaddw v12.8h, v26.8h, v12.8b\n"
          "ld1 {v19.8b}, [" PTR(15) "], %[input_depth]\n"
          "uaddw v13.8h, v26.8h, v13.8b\n"
          "ld1 {v20.8b}, [" PTR(15) "], %[input_depth]\n"
          ...
          DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LOOP ":\n"
            ...
            "add " PTR(11) ", " PTR(11) ", %[input_width_increment]\n"
            "smlal2 v22.4s, v0.8h, v10.8h\n"
            "mov " PTR(12) ", " PTR(11) "\n"
            "smlal v23.4s, v0.4h, v13.4h\n"
            "add " PTR(13) ", " PTR(11) ", %[input_row_size]\n"
            "smlal2 v24.4s, v0.8h, v13.8h\n"
            "add " PTR(14) ", " PTR(13) ", %[input_row_size]\n"
            "smlal v21.4s, v1.4h, v11.4h\n"
            "add " PTR(15) ", " PTR(14) ", %[input_row_size]\n"
        ...
        "mov x12, %[input_ptr]\n"
        "ld1 {v9.8b}, [" PTR(12) "], %[input_depth]\n"
        "add " PTR(13) ", %[input_ptr], %[input_row_size]\n"
        "ld1 {v10.8b}, [" PTR(12) "], %[input_depth]\n"
        "add " PTR(14) ", " PTR(13) ", %[input_row_size]\n"
        "ld1 {v11.8b}, [" PTR(12) "], %[input_depth]\n"
        "add " PTR(15) ", " PTR(14) ", %[input_row_size]\n"
        ...
        "cmp w5, #2\n"
        "ld1 {v17.8b}, [" PTR(14) "], %[input_depth]\n"
        "ld1 {v18.8b}, [" PTR(14) "], %[input_depth]\n"
        "ld1 {v19.8b}, [" PTR(14) "], %[input_depth]\n"
        "ld1 {v21.4s}, [%[bias_ptr]]\n"
        "ld1 {v22.4s}, [" PTR(10) "]\n"
        "ld1 {v23.4s}, [%[bias_ptr]]\n"
        "ld1 {v24.4s}, [" PTR(10) "]\n"
        ...
        "smlal v21.4s, v0.4h, v9.4h\n"
        "ld1 {v12.8b}, [" PTR(12) "], %[input_depth]\n"
        "smlal2 v22.4s, v0.8h, v9.8h\n"
        "ld1 {v16.8b}, [" PTR(13) "], %[input_depth]\n"
        "smlal v23.4s, v0.4h, v10.4h\n"
        "ld1 {v20.8b}, [" PTR(14) "], %[input_depth]\n"
        "smlal2 v24.4s, v0.8h, v10.8h\n"
        "smlal v21.4s, v1.4h, v10.4h\n"
        "smlal2 v22.4s, v1.8h, v10.8h\n"
        "smlal v23.4s, v1.4h, v11.4h\n"
...
#define DEPTHWISECONV_LABEL_HEIGHT_1_END "11"
    ...
    asm volatile(
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_LOOP ":\n"
          ...
          "mov " PTR(11) ", %[input_ptr]\n"
          "mov " PTR(12) ", " PTR(11) "\n"
          "add " PTR(13) ", " PTR(12) ", %[input_row_size]\n"
          "ld1 {v9.8b}, [" PTR(12) "], %[input_depth]\n"
          ...
          "cmp w14, #2\n"
          "ld1 {v11.8b}, [" PTR(12) "], %[input_depth]\n"
          "add " PTR(15) ", " PTR(13) ", %[input_row_size]\n"
          "ld1 {v14.8b}, [" PTR(13) "], %[input_depth]\n"
          "mov " PTR(6) ", %[output_ptr]\n"
          "ld1 {v15.8b}, [" PTR(13) "], %[input_depth]\n"
          "add " PTR(7) ", %[output_ptr], x19\n"
          "ld1 {v16.8b}, [" PTR(13) "], %[input_depth]\n"
          "ld1 {v21.4s}, [%[bias_ptr]]\n"
          "ld1 {v22.4s}, [" PTR(10) "]\n"
          "ld1 {v23.4s}, [%[bias_ptr]]\n"
          ...
          DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LOOP ":\n"
            ...
            "smlal2 v22.4s, v0.8h, v9.8h\n"
            "ld1 {v13.8b}, [" PTR(12) "]\n"
            "add " PTR(12) ", " PTR(15) ", %[input_row_size]\n"
            "smlal v23.4s, v0.4h, v11.4h\n"
            "ld1 {v17.8b}, [" PTR(13) "], %[input_depth]\n"
            "smlal2 v24.4s, v0.8h, v11.8h\n"
            "ld1 {v18.8b}, [" PTR(13) "]\n"
            "add " PTR(13) ", " PTR(12) ", %[input_row_size]\n"
            "smlal v21.4s, v1.4h, v10.4h\n"
            "ld1 {v9.8b}, [" PTR(15) "], %[input_depth]\n"
            "smlal2 v22.4s, v1.8h, v10.8h\n"
            "ld1 {v10.8b}, [" PTR(15) "], %[input_depth]\n"
            "smlal v21.4s, v2.4h, v11.4h\n"
            "smlal2 v22.4s, v2.8h, v11.8h\n"
            "ld1 {v11.8b}, [" PTR(15) "], %[input_depth]\n"
            "smlal v21.4s, v3.4h, v14.4h\n"
            "smlal2 v22.4s, v3.8h, v14.8h\n"
            "ld1 {v14.8b}, [" PTR(12) "], %[input_depth]\n"
            "smlal v23.4s, v3.4h, v16.4h\n"
            "subs w14, w14, #2\n"
            "smlal2 v24.4s, v3.8h, v16.8h\n"
            "cmp w14, #3\n"
        ...
        "ld1 {v13.8b}, [" PTR(13) "], %[input_depth]\n"
        "ld1 {v14.8b}, [" PTR(13) "], %[input_depth]\n"
        "ld1 {v15.8b}, [" PTR(15) "], %[input_depth]\n"
        "ld1 {v16.8b}, [" PTR(15) "], %[input_depth]\n"
        "ld1 {v17.8b}, [" PTR(15) "], %[input_depth]\n"
...
#define DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP "2"
    asm volatile(
        ...
        "ldr x9, [%[params_ptr], #" STR(OFFSET_INPUT_ROW_SIZE) "]\n"
        "cmp x15, #16\n"
        "add " PTR(12) ", %[input_ptr], x15\n"
        "add " PTR(13) ", %[input_ptr], x9\n"
        "ld1 {v8.8b}, [%[input_ptr]], #8\n"
        "add x14, x13, x15\n"
        "ld1 {v9.8b}, [" PTR(12) "], #8\n"
        "ldr x6, [%[params_ptr], #" STR(OFFSET_FILTER_ROW_SIZE) "]\n"

        "add " PTR(9) ", %[filter_ptr], x15\n"
        "ld1 {v10.8b}, [" PTR(13) "], #8\n"
        "add " PTR(10) ", %[filter_ptr], x6\n"
        "ld1 {v11.8b}, [" PTR(14) "], #8\n"
        "ld1 {v0.8b}, [%[filter_ptr]], #8\n"
        "add x11, x10, x15\n"
        "ld1 {v1.8b}, [" PTR(9) "], #8\n"
...
#define DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP "2"
    asm volatile(
        ...
        "ld1 {v11.8b}, [" PTR(13) "], x7\n"
        "add %[filter_ptr], %[filter_ptr], #8\n"
        "ld1 {v12.8b}, [" PTR(13) "], x7\n"
        "ld1 {v13.8b}, [" PTR(13) "]\n"
...
#define DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP "2"
    asm volatile(
        ...
        "cmp x15, #16\n"
        "add x10, x9, x5\n"
        "ld1 {v10.8b}, [" PTR(13) "], x6\n"
        "add %[input_ptr], %[input_ptr], #8\n"
        "ld1 {v11.8b}, [" PTR(13) "]\n"
        "add %[filter_ptr], %[filter_ptr], #8\n"
        "ld1 {v12.8b}, [" PTR(14) "], x6\n"
        "ld1 {v13.8b}, [" PTR(14) "]\n"
...
#define DC_KERNEL_MULT_23 "23"
    ...
    asm volatile(
        ...
        "add    x6, x6, #4\n"  // =4
        "mov    x12, x6\n"
        "ld1    { v25.s }[1], [" PTR(12) "], %[output_block_data]\n"
        "ldr    w3, [sp, #316]\n"  // 4-byte Folded Reload
        "ld1    { v26.s }[1], [" PTR(12) "]\n"
        "ldr    w12, [sp, #320]\n"  // 4-byte Folded Reload
        "cmp    w13, w3\n"
