...
def _tf_repositories():
    ...
    tf_http_archive(
        name = "XNNPACK",
        sha256 = "17dcca3a1790f0b46f1237a01fea82fa822723424b80fa5c864b55601a2bfefd",
        strip_prefix = "XNNPACK-1fed3386ee370415a4d796e9999b4422ba642cc2",
        urls = tf_mirror_urls("https://github.com/google/XNNPACK/archive/1fed3386ee370415a4d796e9999b4422ba642cc2.zip"),
    )
